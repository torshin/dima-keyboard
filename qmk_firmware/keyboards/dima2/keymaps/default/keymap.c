...
KC_LALT            , KC_Z   , KC_X            , KC_C    , KC_V         , KC_B              , SWT_LNG                                                 , SWT_LNG         , KC_N               , KC_M                , KC_COMM , KC_DOT  , KC_SLSH , RALT_T(KC_RBRC) ,
											    KC_LGUI , LT(_MOUSE, KC_RSFT) , LT(_RAISE,KC_TAB) , LSFT_T(KC_SPC) , LT(_LOWER, KC_DEL) , LT(_LOWER,KC_ESC) , RSFT_T(KC_BSPC) , LT(_RAISE, KC_ENT) , LT(_MOUSE, KC_RSFT) , KC_BSLS
)                  ,
...
[_MOUSE] = LAYOUT(
RALT(KC_GRV)    , KC_PSLS  , KC_KP_7   , KC_KP_8  , KC_KP_9   , KC_PMNS                                                        , KC_WH_U     , KC_BTN1         , KC_MS_U      , KC_BTN2       , _______       , RALT(KC_LBRC),
_______         , KC_PAST  , KC_KP_4   , KC_KP_5  , KC_KP_6   , KC_PPLS                                                           , KC_WH_D     , KC_MS_L         , KC_MS_D      , KC_MS_R       , _______       , RALT(KC_QUOT),
_______         , KC_KP_0  , KC_KP_1   , KC_KP_2  , KC_KP_3   , KC_PDOT     , _______                              , _______      , _______     , RALT(KC_M)     , RALT(KC_COMM) , RALT(KC_DOT)  , RALT(KC_SLSH) , RALT(KC_RBRC),
