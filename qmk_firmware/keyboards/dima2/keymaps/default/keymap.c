...
[_RAISE] = LAYOUT(
_______            , KC_NLCK      , KC_PSLS           , KC_P7          , KC_P8              , KC_P9             , KC_PMNS         , KC_VOLU            , KC_HOME             , KC_PSCR , KC_PGUP , KC_SLCK         ,
LCTL_T(KC_EQL)     , KC_PAST      , KC_P4             , KC_P5          , KC_P6              , KC_PPLS           , KC_MUTE         , KC_LEFT            , KC_UP               , KC_RGHT , KC_INS  , RCTL_T(KC_APP)  ,
_______            , KC_P0        , KC_P1             , KC_P2          , KC_P3              , KC_PCMM           , _______         , _______            , KC_VOLD             , KC_END  , KC_DOWN , KC_PGDN         , KC_PAUS , _______         ,
_______            , _______      , _______           , _______        , LT(_THIRD,KC_ENT)  , _______           , _______         , _______            , _______             , _______
...
_______            , RESET        , _______           , _______        , _______            , _______           , _______         , _______            , _______             , RESET
